        ...
        <div style={{ border: 'var(--borderColor)' }}
            ...
            <div className="position-relative">
                ...
                <div style={{
                    ...
                    filter: 'blur(189px)',
                    inset: '0px',
                    background: 'radial-gradient(pink, blue, red)'
                }}></div>

                {/* Foreground Content */}
                <div className="container m-auto position-relative" style={{ zIndex: 1 }}>
                            ...
                            <div key={index} className={`carousel-item ${index === 0 ? 'active' : ''}`} data-bs-interval="3000">
                                ...
                                <div className="row d-flex justify-content-center">
                                    <div className="col-lg-8">
                                        <img className=" cardBoxShadow" src={image} alt="DIIT Student" style={{ width: "150px", border: '8px solid var(--mainBgcolor)', borderRadius: '4rem 4rem 1rem 1rem' }} />
                                        <div className="fw-bold p-3" style={{ width: '15rem', height: '4rem', margin: 'auto', background: 'var(--mainBgcolor) ', borderRadius: '4rem 4rem 0 0' }}>
                                            <h4 className="m-0 p-0 text-light">{name}</h4>
                                            <font color="#00beff">{role}</font>
                                        </div>
                                        <p id={`PortfolioText${index + 1}`} className='p-4' style={{ background: 'var(--mainBgcolor)', borderRadius: '4rem 4rem 0.5rem 0.5rem' }}>
