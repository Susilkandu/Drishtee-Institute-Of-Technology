                                ...
                                <div className="offcanvas-body m-0 p-0">
                                    ...
                                    <div className='text-start py-3 dbtext'>
                                        <ul>
                                            ...
                                            <li><i className="fa fa-calendar" aria-hidden="true"></i> &nbsp; Date of birth: <b>{new Date(details.dob).toDateString()}</b></li>
                                            <li><i className="fa fa-calendar" aria-hidden="true"></i> &nbsp; Admission date: <b>{new Date(details.createdAt).toDateString()}</b></li>
                                            <li><i className="fa fa-clock-o" aria-hidden="true"></i> &nbsp; Course Completed:  {details.completed ? (<b>Completed</b>) : (<b>Ongoing</b>)}</li>
                                        </ul>
                                    </div>
