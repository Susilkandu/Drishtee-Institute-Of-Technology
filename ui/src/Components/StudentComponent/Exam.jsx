...
export default function Exam() {
    ...
    return (
        <>
            <div className="container-fluid row w-100 m-auto  mb-4 bg-white shadow  py-4 ">
                ...
                <div className="text-center my-4"  onClick={() => { applyForm(true, examData._id) }}>
                    <button disabled = {`!examData`} className="btn btn-primary">Apply for Examination</button>
                </div>
                <>
                    <div class="d-flex align-items-start">
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <button class="nav-link " id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" onClick={()=>{startExamination(true)}}>Start  Examination</button>
                        </div>
                    </div>
                </>
            </div>
