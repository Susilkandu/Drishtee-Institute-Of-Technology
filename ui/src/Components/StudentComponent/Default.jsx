                            ...
                            <div className="d-flex container m-auto bg-white text-start mshadow2 p-0 m-0">
                                <div className="p-2 m-0 d-flex flex-fill justify-content-evenly border border-warning m-1">
                                    <div>
                                        ...
                                        <h5 className='m-0 p-0 mdanger fw-bolder'>88%</h5>
                                    </div>
                            ...
                            <div className="container my-3">
                                <div>
                                    ...
                                    <div className=" small text-start" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                                        ...
                                        <p>{details.name} is the student of DRISHTEE INSTITUTE OF INFORMATION TECHNOLOGY, Nichlaul Maharajganj, Uttar-Pradesh 273305.</p>
                                        <p>His father's name is {details.fatherName}. This {details.address}. He has done the {details.course} course from our Drishti Computer Center Below.</p>
                                    </div>
                                </div>
