      ...
      <div className="row d-flex justify-content-center">
        <div className="col-12 col-md-8 bg-white py-3 my-3 myshadow">
          <div className="p-2">
            ...
            <hr />
            <div className="text-center"><a className="small" href="#">Forgot Password?</a></div>
            <div className="text-center mb-3"><a className="small" href="#">Already have an account? Login!</a></div>
          </div>
        </div>
      </div>
    </div>
