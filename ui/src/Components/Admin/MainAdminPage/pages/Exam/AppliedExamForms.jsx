            ...
            <div className="row m-0 p-0 pb-5">
                ...
                <div className="col-md-12 mb-5 mx-0 px-1">
                    <div className="table-responsive">
                        <table className="container diplomaTable  m-auto table table-responsive table-sm small p-0 my-3 shadow">
                            ...
                            <tbody>
                                {
                                    formList && formList.map((stdnt) => {
                                        return (
                                            <tr key={stdnt.id} >
                                                <td ><img width="70px" height="70px" src={stdnt.photo} alt="Loading..." /></td>
                                                <td>{stdnt.regNum}</td>
                                                <td>{stdnt.name}</td>
