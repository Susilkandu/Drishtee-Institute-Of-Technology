                    ...
                    <div className="col-xl-4 col-xxl-3 col-sm-6 my-2 w-100">
                        <div className="card myshadow border-0" id="NotishBoard">
                            <div className="card-header h4 text-white text-start" style={{ background: "var(--cardHeadColor )" }}>
                                <div data-aos="fade-right" className='d-flex justify-content-between'><div> <i className="fa fa-comments text-warning" aria-hidden="true"></i> NEW MESSAGE</div> <button className="btn btn-warning" onClick={fetchAllQuery} >Reload</button> </div>
                            </div>
