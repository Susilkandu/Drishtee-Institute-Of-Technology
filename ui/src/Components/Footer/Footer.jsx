...
const otherLinksData = [
    { text: 'Certificate Verification', link: '/Download-Certificate' },
...
const links = [
    ...
    {
        to: 'https://maps.app.goo.gl/eRr649A7s3KMCVAE9',
        iconClass: '',
        imgSrc: './images/icon/gmap.png',
        imgAlt: 'Map',
        imgWidth: '40px',
        title: 'Go to map'
    }
    ...
    return (
        <footer className="text-white text-lg-start py-4 border border-top" id="MyFooterColor" style={{ background: 'var(--cardHeadColorDark)' }}>
            <div className="container-fluid border-bottom">
                <div className="row">
                    {/* Column 1: ADDRESS */}
                    <div className="col-md-4 mb-4 mb-md-0 p-0">
            ...
            <div className="p-3 text-center small" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }} id="lastFooter">
                &copy; 2024 DIIT All Rights Reserved <br /><b style={{
                    color: 'rgb(0, 190, 255)',
                    fontSize: '1rem',
                    fontweight: 'bold'
                }}> Developed by :- Er. Sushil kandu (MetaTech Innovations)</b>
            </div>
        </footer>
    );
}
